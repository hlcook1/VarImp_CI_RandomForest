ClassSim <- function(data,sim_number,n=250,n_boots=100,n_subs=100,n_trees=250,n_splitpred=20^(1/2),termnodesize=5){
  ...
  rf.fit<-rfsrc(y~.,data=data_use,mtry = n_splitpred,ntree = n_trees,importance="permute",
                ...
                perf.type="brier")
  #for classification, also need perf.type="brier", may also need splitrule="gini,auc,entropy"
  ...
  png(paste("Plots\\Sim",sim_number,"_AllCIs_RFmodel",run,".png",sep=""),width=2000,height=1000)
